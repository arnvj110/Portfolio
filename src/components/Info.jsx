...
const Info = ({ show,x }) => {
  ...
  return (
    <div className={`ml-auto bg-[url(/public/cool-background-black.png)] text-gray-200 bg-cover bg-center  font-mono transition-all duration-1000 ease-in-out top-0 h-[100%] ${show ? 'w-[1000px]' : 'w-[1350px]'} border border-black -right-2 flex justify-center items-center rounded-l-2xl bg-white shadow-2xl`}>
...
rounded-full w-[200px] h-[200px] text-lg  transition-all duration-500 ease-in-out hover:scale-105 bg-[url(/public/me1.jpg)] bg-cover bg-center  ml-auto shadow-2xl overflow-hidden'>
