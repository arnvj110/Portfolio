...
const Info = ({ show,x,logo }) => {
  ...
  return (
    <div className={`ml-auto bg-[url(/cool-background-black.png)] text-gray-200 bg-cover bg-center  font-mono transition-all duration-1000 ease-in-out top-0 h-[100%] ${show ? 'w-[1000px]' : 'w-[1350px]'} border border-black -right-2 flex justify-center items-center rounded-l-2xl bg-white shadow-2xl`}>
      <div className='w-[85%] h-[90%]  gap-4'>
        ...
        <div className=' flex'>
        <div className='h-[230px] flex flex-col justify-center  w-[50%]'>
          
          <span className='mb-5'>Contact - arnavjain92105@gmail.com</span>
          
          <div className='flex gap-2 pl-[70px] '>
           
            <span className='cursor-pointer rounded-full bg-white border' >
              <a target='_blank' href="https://www.linkedin.com/in/arnav-jain-820522322/" >
                <svg className='w-10' xmlns="http://www.w3.org/2000/svg" width="99.59"  viewBox="0 0 99.59 99.59" id="linkedin-circle">
                  <defs>
            ...
            <span className='cursor-pointer border rounded-full' >
  ...
  <g id="SVGRepo_bgCarrier" strokeWidth="0">
    <rect x="0" y="0" width="20" height="20" rx="10" fill="#ffffff" strokeWidth="0"></rect>
  </g>
...
<div className='  ml-auto '>
  {!logo && 
<div className='mt-[26px] transition-all  duration-1500 ease-in-out border text-white bg-gray-600 rounded-full
bg-[url(/me1.jpg)] bg-cover bg-center
shadow-2xl hover:scale-105 cursor-pointer z-50 w-[200px] h-[200px]'>
        ...
        <div className='mt-4 flex flex-col gap-2'>
          ...
          <span>Frontend: HTML, CSS, JavaScript, Vite + React, Tailwind</span>
          <span>Backend (learning): Node.js, Express</span>
          <span>Programming Languages: C++</span>
          <span>Problem-Solving: DSA (ongoing practice)</span>
        </div>
      </div>
    </div>
  )
